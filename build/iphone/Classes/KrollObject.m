 ...
 * Copyright (c) 2009-2011 by webview_event_bubbling, Inc. All Rights Reserved.
...
//@interface webview_event_bubblingObject : NSObject
//@end

@interface webview_event_bubblingObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[webview_event_bubblingObject class]])
		{
			for (NSString *key in [[(webview_event_bubblingObject*)o modules] allKeys])
			{
