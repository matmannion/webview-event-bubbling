...
@interface webview_event_bubblingObject : KrollCoverageObject {
#else
@interface webview_event_bubblingObject : KrollObject {
#endif
@private
...
extern NSString * webview_event_bubbling$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	webview_event_bubblingObject *_webview_event_bubbling;
	BOOL shutdown;
