...
// in simulator we redefine to format for webview_event_bubbling Developer console
...
{\
	NSString * exceptionName = [@"org.webview_event_bubbling." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.webview_event_bubbling";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIwebview_event_bubblingNativeItemNone = -1, 
	UIwebview_event_bubblingNativeItemSpinner = -2,
	UIwebview_event_bubblingNativeItemProgressBar = -3,
	
	UIwebview_event_bubblingNativeItemSlider = -4,
	UIwebview_event_bubblingNativeItemSwitch = -5,
	UIwebview_event_bubblingNativeItemMultiButton = -6,
	UIwebview_event_bubblingNativeItemSegmented = -7,
	
	UIwebview_event_bubblingNativeItemTextView = -8,
	UIwebview_event_bubblingNativeItemTextField = -9,
	UIwebview_event_bubblingNativeItemSearchBar = -10,
	
	UIwebview_event_bubblingNativeItemPicker = -11,
	UIwebview_event_bubblingNativeItemDatePicker = -12,
	
	UIwebview_event_bubblingNativeItemInfoLight = -13,
	UIwebview_event_bubblingNativeItemInfoDark = -14,
	
	UIwebview_event_bubblingNativeItemDisclosure = -15,
	
	UIwebview_event_bubblingNativeItemContactAdd = -16
};
